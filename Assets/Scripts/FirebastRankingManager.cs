...
public class FirebastRankingManager : MonoBehaviour
{
    public const string url = "https://test-e7344-default-rtdb.asia-southeast1.firebasedatabase.app/";
    public const string secret = "ZzYAiBkjvpSqLie5Zc5jRVOjMdXTlwl2hz8zFuKR";

    [Header("Main")]
    public RanlkUIManager ranlkUIManager;
    [System.Serializable]
    ...
    {
        ranking.playerDatas = ranlkUIManager.playerDatas;
    ...
    {
        ranlkUIManager.yourRankData.playerData = ranking.playerDatas.Where(data => data.playerName == currentPlayerData.playerName).FirstOrDefault();
        ranlkUIManager.yourRankData.UpdateData();
    }
    public void ReloadSortingData()
    {
        ...
        RestClient.Get(urlData).Then(response =>
        {
            ...
            {
                Debug.Log("Upload!");
                ranlkUIManager.playerDatas = ranking.playerDatas;
                ranlkUIManager.ReloadRankData();
